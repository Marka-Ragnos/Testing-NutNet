...
const sprite = () => {
  const spriteData = gulp.src("source/img/sprite/*.png").pipe(
    spritesmith({
      imgName: "sprite.png",
  ...
  const imgStream = spriteData.img.pipe(gulp.dest("build/img/"));

  // Pipe CSS stream onto disk
  const cssStream = spriteData.css.pipe(gulp.dest("source/sass"));
